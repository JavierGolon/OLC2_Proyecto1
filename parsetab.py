...
_lr_productions = [
  ...
  ('tipo -> ARRAY PARIZQ PARDER','tipo',3,'p_tipo','Gramatica.py',238),
  ...
  ('instruccionregistro -> ABS PARIZQ registro PARDER','instruccionregistro',4,'p_instruccionregistro_diferentes','Gramatica.py',269),
  ('instruccionregistro -> NOTLOGICA registro','instruccionregistro',2,'p_instruccionregistro_diferentes','Gramatica.py',270),
  ('instruccionregistro -> NOTBIT registro','instruccionregistro',2,'p_instruccionregistro_diferentes','Gramatica.py',271),
  ('instruccionregistro -> MENOS registro','instruccionregistro',2,'p_instruccionregistro_diferentes','Gramatica.py',272),
  ('instruccionregistro -> registro','instruccionregistro',1,'p_instruccion_registrounico','Gramatica.py',274),
  ('registro -> acceso','registro',1,'p_registro','Gramatica.py',277),
  ('registro -> ENTERO','registro',1,'p_registro','Gramatica.py',278),
  ('registro -> CADENA','registro',1,'p_registro','Gramatica.py',279),
  ('registro -> DECIMAL','registro',1,'p_registro','Gramatica.py',280),
  ('acceso -> variable dimension','acceso',2,'p_acceso','Gramatica.py',284),
  ('acceso -> variable','acceso',1,'p_acceso','Gramatica.py',285),
  ('dimension -> dimension CORCHETEIZQ inside CORCHETEDER','dimension',4,'p_dimension','Gramatica.py',288),
  ('dimension -> CORCHETEIZQ inside CORCHETEDER','dimension',3,'p_dimension','Gramatica.py',289),
  ('inside -> ENTERO','inside',1,'p_inside','Gramatica.py',293),
  ('inside -> CADENA','inside',1,'p_inside','Gramatica.py',294),
  ('inside -> acceso','inside',1,'p_inside','Gramatica.py',295),
  ('conversion -> PARIZQ eltipo PARDER registro','conversion',4,'p_conversion','Gramatica.py',300),
  ('eltipo -> FLOAT','eltipo',1,'p_eltipo','Gramatica.py',304),
  ('eltipo -> INT','eltipo',1,'p_eltipo','Gramatica.py',305),
  ('eltipo -> CHAR','eltipo',1,'p_eltipo','Gramatica.py',306),
  ('exit -> EXIT PTCOMA','exit',2,'p_exit','Gramatica.py',309),
  ('print -> PRINT PARIZQ instruccionregistro PARDER PTCOMA','print',5,'p_print','Gramatica.py',312),
  ('etiqueta -> ETIQUETA DOSPUNTOS','etiqueta',2,'p_etiqueta','Gramatica.py',315),
  ('goto -> GOTO ETIQUETA PTCOMA','goto',3,'p_goto','Gramatica.py',318),
  ('read -> READ PARIZQ PARDER PTCOMA','read',4,'p_read','Gramatica.py',321),
  ('unset -> UNSET PARIZQ registro PARDER PTCOMA','unset',5,'p_unset','Gramatica.py',324),
  ('ifcomando -> IF PARIZQ instruccionregistro PARDER GOTO ETIQUETA PTCOMA','ifcomando',7,'p_if','Gramatica.py',327),
]
